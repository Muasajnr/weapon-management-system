                ...
                <div class="card">
                    <div class="card-header">
                        <?php if ($userLevel === 'admin'): ?>
                            <button type="button" class="btn btn-primary btn-xs mr-2" data-toggle="modal" data-target="#modal_add_pinjam">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="data_pinjam" class="table table-bordered table-hover table-sm" width="100%">
                            <thead>
                                <tr>
...
<?php echo view($moduleViewPath.'pinjam/custom_js') ?>