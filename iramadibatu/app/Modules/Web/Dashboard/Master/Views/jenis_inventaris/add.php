<div class="modal fade" id="modal_add_jenis_inventaris">
            ...
            <div class="modal-body pb-0">
                <div class="card-body pb-0 pt-0 text-right">
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                        <input type="checkbox" name="is_single_insert" class="custom-control-input" id="is_single_insert">
                        <label class="custom-control-label" for="is_single_insert">Single-Insert</label>
                    </div>
                </div>
            </div>
            <form id="form_add_jenis_inventaris">
