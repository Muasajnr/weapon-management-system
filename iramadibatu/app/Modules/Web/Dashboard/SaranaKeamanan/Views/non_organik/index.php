    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-primary btn-xs mr-2" data-toggle="modal" data-target="#modal-add-non-organik">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="data_non_organik" class="table table-bordered table-hover table-sm" width="100%">
                            <thead>
                                <tr>
...
<?php echo view($moduleViewPath.'non_organik/custom_js') ?>