...
if (!is_cli()) {
    ...
    /** scan all path and it's sub path to find Routes.php */
    ...
    /** scan only the path below app/Modules */
    $dir = scandir(ROOTPATH.'app/Modules');

    foreach($dir as $module) {
        if ($module == '.' || $module == '..')
            continue;
        
        $moduleFiles = scandir(ROOTPATH.'app/Modules/'.$module);
