...
class JenisSaranaController extends BaseController
{
    private $jenisSaranaModel;

    public function __construct()
    {
        $this->jenisSaranaModel   = new JenisSaranaModel();
    }
    ...
    public function datatables()
    {
        ...
        $data                   = $this->jenisSaranaModel->getDatatables($searchQuery['value'], $start, $length, $order);
        $recordsTotal           = $this->jenisSaranaModel->getTotalRecords($searchQuery['value'], $order);
        $recordsFiltered        = $this->jenisSaranaModel->getTotalFilteredRecords();
