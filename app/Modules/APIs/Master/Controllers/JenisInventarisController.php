...
class JenisInventarisController extends BaseController
{
    ...
    private $jenisInventarisModel;

    public function __construct()
    {
        $this->jenisInventarisModel   = new JenisInventarisModel();
    }
    ...
    public function datatables()
    {
        ...
        $data                   = $this->jenisInventarisModel->getDatatables($searchQuery['value'], $start, $length, $order);
        $recordsTotal           = $this->jenisInventarisModel->getTotalRecords($searchQuery['value'], $order);
        $recordsFiltered        = $this->jenisInventarisModel->getTotalFilteredRecords();
