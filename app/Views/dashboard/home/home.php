                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">Total Barang Berdasarkan Jenis Inventaris</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">Total Barang Berdasarkan Jenis Senjata Api</h3>
                            <a href="javascript:void(0);">Lihat laporan</a>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header border-transparent">
                        <h3 class="card-title">Top 5 Senjata Api</h3>
                    </div>
                    <!-- /.card-header -->
