...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Merk Senjata Api</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<?php echo view('dashboard/master/firearms_brands/add'); ?>
<?php echo view('dashboard/master/firearms_brands/edit'); ?>

<?=$this->endSection()?>

<?php echo view('dashboard/master/firearms_brands/custom_js'); ?>