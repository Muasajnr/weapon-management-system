...
$(function() {
    ...
    // handles datatable
    const table = $('#data-firearms-brands').DataTable({
        "responsive": true,
    ...
    $('#data-firearms-brands tbody').on('change', 'tr td input[type="checkbox"][name="is_active"]', function(e) {
        e.preventDefault();
        console.log($(this));
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const updateUrl = '<?=site_url('api/dashboard/firearms-brands/')?>' + itemId + '/update/status';
    ...
    // handle create data
    $('#form-add-firearm-brand').validate({
        submitHandler: function(form, event) {
            ...
            const createUrl = '<?=site_url('api/dashboard/firearms-brands')?>';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => {
                        $('#modal-add-new-firearm-brand').modal('toggle');
    ...
    // handle update data
    $('#form-edit-firearm-brand').validate({
        submitHandler: function(form, event) {
            event.preventDefault();
            ...
            const updateUrl = '<?=site_url('api/dashboard/firearms-brands/')?>' + itemId + '/update';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => {
                        $('#modal-edit-firearms-brands').modal('toggle');
                        table.ajax.reload();
                    }, 2000);
                },
                error: function(err) {
    ...
    // handle edit data
    $('#data-firearms-brands tbody').on('click', 'tr td button.btn-info', function(e) {
        e.preventDefault();
    ...
    // handle delete data
    $('#data-firearms-brands tbody').on('click', 'tr td button.btn-danger', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const deleteUrl = '<?=site_url('api/dashboard/firearms-brands/')?>' + itemId + '/delete';
    ...
    $('#btn-delete-multiple').click(function(e) {
        ...
        if (selectedRows.length > 0) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const deleteUrl = '<?=site_url('api/dashboard/firearms-brands/delete/multiple')?>';
                    const ids = [];
