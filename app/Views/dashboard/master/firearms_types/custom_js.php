...
$(function() {
    ...
    // handles datatable
    const table = $('#data-firearms-types').DataTable({
        ...
        "ajax": function(data, callback, settings) {
            const dataUrl = '<?=site_url('api/dashboard/firearms-types/datatables')?>';
            let result = null;
    ...
    $('#data-firearms-types tbody').on('change', 'tr td input[type="checkbox"][name="is_active"]', function(e) {
        e.preventDefault();
        console.log($(this));
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const updateUrl = '<?=site_url('api/dashboard/firearms-types/')?>' + itemId + '/update/status';
    ...
    // handle create data
    $('#form-add-firearms-types').validate({
        submitHandler: function(form, event) {
            ...
            const createUrl = '<?=site_url('api/dashboard/firearms-types')?>';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => {
                        $('#modal-add-firearms-types').modal('toggle');
    ...
    // handle update data
    $('#form-edit-firearms-types').validate({
        submitHandler: function(form, event) {
            event.preventDefault();
            ...
            const updateUrl = '<?=site_url('api/dashboard/firearms-types/')?>' + itemId + '/update';
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => {
                        $('#modal-edit-firearms-types').modal('toggle');
                        table.ajax.reload();
                    }, 2000);
                },
                error: function(err) {
    ...
    // handle show detail
    $('#data-firearms-types tbody').on('click', 'tr td button.btn-primary', function(e) {
        e.preventDefault();
    ...
    // handle edit data
    $('#data-firearms-types tbody').on('click', 'tr td button.btn-info', function(e) {
        e.preventDefault();
    ...
    // handle delete data
    $('#data-firearms-types tbody').on('click', 'tr td button.btn-danger', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const deleteUrl = '<?=site_url('api/dashboard/firearms-types/')?>' + itemId + '/delete';
    ...
    $('#btn-delete-multiple').click(function(e) {
        ...
        if (selectedRows.length > 0) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const deleteUrl = '<?=site_url('api/dashboard/firearms-types/delete/multiple')?>';
                    const ids = [];
