                    ...
                    <div class="card-body">
                        <form id="form-edit-document">
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_name" class="form-control" id="doc_name" value="<?=$doc_edit_data->doc_name?>" placeholder="Masukkan Judul...">
                            </div>
                            <div class="form-group">
                                <label for="doc_number">No. Berita Acara</label>
                                <input type="text" name="doc_number" class="form-control" id="doc_number" value="<?=$doc_edit_data->doc_number?>" placeholder="Masukkan Nomor...">
                            </div>
                            <!-- Date -->
                            <div class="form-group">
                            <label for="doc_date">Tanggal:</label>
                                <div class="input-group date" id="doc_date" data-target-input="nearest">
                                    <input type="text" name="doc_date" class="form-control datetimepicker-input" value="<?=$doc_edit_data->doc_date?>" data-target="#doc_date"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="doc_media"><?=$doc_edit_data->uploaded_media_name?></label>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="doc_type" value="borrowing" <?=$doc_edit_data->doc_type == 'borrowing' ? 'checked' : ''?>>
                                    <label class="form-check-label">Peminjaman</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="doc_type" value="returning" <?=$doc_edit_data->doc_type == 'returning' ? 'checked' : ''?>>
...
$(function() {
    ...
    $('#form-edit-document').validate({
        submitHandler: function(form, event) {
            ...
            if (newDoc.get('doc_media') !== undefined && (newDoc.get('doc_media').size / 1000) > 1600) {
                Swal.fire({
                    icon: 'error',
                    title: 'Terjadi error!',
            ...
            $.ajax({
                type: 'POST',
                url: '<?=site_url('api/dashboard/documents/'.$doc_id.'/update')?>',
                data: newDoc,
                dataType: 'json',
