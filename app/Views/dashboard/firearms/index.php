    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?=route_to('firearms_add')?>" type="button" class="btn btn-primary btn-sm mr-2">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <table id="data-firearms" class="table table-bordered table-hover table-sm" width="100%">
                <thead>
                    <tr>
