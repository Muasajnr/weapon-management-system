...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Peminjaman Senjata</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Peminjaman Senjata</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="data-borrowings" class="table table-bordered table-hover table-sm" width="100%">
                    <thead>
                        <tr>
